...
REM the input folder dragged onto this script
set "inp=%~1"
...
REM ---------------------------------------------------------------------------------------------------
@echo off
REM this IT test only works if there's a trailing slash
...
del "!target_subfolder!*.pdf">NUL 2>&1

set cmd1="!slideshow_Irfanviewexe64!" "!source_subfolder!*.jpg"  /ini="!ini_folder!" /advancedbatch /convert="!target_subfolder!*.jpg"
set cmd2="!slideshow_Irfanviewexe64!" "!source_subfolder!*.jepg" /ini="!ini_folder!" /advancedbatch /convert="!target_subfolder!*.jpeg"
...
set cmd5="!slideshow_Irfanviewexe64!" "!source_subfolder!*.pdf"  /ini="!ini_folder!" /advancedbatch /convert="!target_subfolder!*.pdf"
echo !cmd1!
!cmd1!
echo !cmd2!
!cmd2!
