...
REM set "pth=G:\DVD\PAT-SLIDESHOWS\_AI_06_in_development"
...
"C:\SOFTWARE\Vapoursynth-x64\VSPipe.exe" --container y4m "G:\DVD\PAT-SLIDESHOWS\_AI_06_in_development\_AI_06.vpy" - >NUL
"C:\SOFTWARE\Vapoursynth-x64\VSPipe.exe" --container y4m "G:\DVD\PAT-SLIDESHOWS\_AI_06_in_development\_AI_04.vpy" - >NUL
