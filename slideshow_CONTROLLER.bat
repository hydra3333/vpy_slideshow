...
REM echo "%py_path%MediaInfo.exe" --full slideshow.FINAL_MP4_WITH_AUDIO_FILENAME.mp4 >>"!log!" 2>&1
REM "%py_path%MediaInfo.exe" --full slideshow.FINAL_MP4_WITH_AUDIO_FILENAME.mp4 >>"!log!" 2>&1
